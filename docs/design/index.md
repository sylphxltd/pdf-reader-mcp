...
- **Agent Document Map** - One navigable contract linking pages, elements, text-layer and metadata coverage, chunks, layout diagnostics, safety findings, trust report routing, accessibility report routing, visual evidence routing, and page geometry
...
- **Document Map** - Pages, elements, text-layer and metadata coverage, chunks, layout diagnostics, safety findings, trust report routing, accessibility report routing, visual evidence routing, and geometry are linked from one response shape
