...
| `visual_region_analysis_quality` | Local command, HTTP, Ollama-preset, and OpenAI-compatible visual-region provider normalization for table cells/spans/boxes, formula fields, chart axes/series, figure and image-description evidence, confidence, warnings, request shape, and crop evidence |
