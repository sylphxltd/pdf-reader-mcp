...
1. Continue broadening real fixture coverage for the no-new-dependency parity
   ...
   additional tagged structures, multi-caption/multi-target visual layouts, and
   safety adversarial fixtures still need broader coverage.
