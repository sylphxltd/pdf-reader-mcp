...
8. Harden optional visual region providers for table, formula, chart, figure,
   ...
   the Ollama/OpenAI-compatible preset request/response contracts, and the
   installed visual-region `visual-full-fidelity` certification benchmark.
