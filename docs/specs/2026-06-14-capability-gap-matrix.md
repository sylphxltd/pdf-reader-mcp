...
| Advanced parser engine adapters | In progress | OCR and visual region provider boundaries, built-in OCR preset health metadata, and provider benchmark certification profiles are shipped; broader engine-specific accuracy fixtures remain. |
