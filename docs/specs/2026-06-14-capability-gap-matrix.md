...
| Agent document map | Shipped | `include_document_map`; links pages, elements, selectable text-layer coverage, chunks, layout diagnostics, safety findings, routing signals, OCR evidence, visual-region candidate indexes, visual enrichment indexes, and page geometry in one agent-ready contract. |
