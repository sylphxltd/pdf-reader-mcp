...
3. Harden the agent document map as the SSOT for pages, elements, text-layer
   coverage, chunks, layout, safety, trust routing, accessibility routing, page
   geometry, and optional engine enrichment.
