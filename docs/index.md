...
features:
  ...
  - icon: "\U0001F5BC\uFE0F"
    ...
    details: Return an agent document map, text layer, semantic document AST, trust report, and accessibility report with stable element IDs, caption links, citation chunks, table quality diagnostics, layout confidence, safety signals, page geometry, provenance, and best-effort coordinates.
  - icon: "\U0001F9FE"
