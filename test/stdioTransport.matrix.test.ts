...
describe('MCP stdio transport routing', () => {
  it('bin wrapper defaults to Rust rmcp stdio server with explicit TS opt-in', () => {
  ...
  it('check-no-ts-stdio-backend gate enforces default stdio Rust authority', () => {
  ...
  it('migration ledger marks transport/stdio-rust-rmcp as rust_impl with rej-010 differential harness', () => {
