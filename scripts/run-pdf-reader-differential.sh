...
V3014_FORM_RADIO_AS_NO_OVERRIDE_RESIDUAL_JSON="$SCRATCH/v3014-form-radio-as-no-override-residual-result.json"
V3014_FORM_CHECKBOX_MULTI_EXPORT_RESIDUAL_JSON="$SCRATCH/v3014-form-checkbox-multi-export-residual-result.json"
V3014_FORM_CHECKBOX_MULTI_EXPORT_MANY_RESIDUAL_JSON="$SCRATCH/v3014-form-checkbox-multi-export-many-residual-result.json"
V3014_FORM_CHECKBOX_EXPORT_EMPTY_SINGLE_RESIDUAL_JSON="$SCRATCH/v3014-form-checkbox-export-empty-single-residual-result.json"
V3014_FORM_CHECKBOX_MALFORMED_AP_RESIDUAL_JSON="$SCRATCH/v3014-form-checkbox-malformed-ap-residual-result.json"
V3014_FORM_RADIO_MALFORMED_AP_RESIDUAL_JSON="$SCRATCH/v3014-form-radio-malformed-ap-residual-result.json"
...
V3014_ANNOTATION_FREETEXT_RECT_RESIDUAL_JSON="$SCRATCH/v3014-annotation-freetext-rect-residual-result.json"
V3014_ANNOTATION_LINK_URI_NAME_RESIDUAL_JSON="$SCRATCH/v3014-annotation-link-uri-name-residual-result.json"
V3014_ANNOTATION_LINK_AA_ACTION_RESIDUAL_JSON="$SCRATCH/v3014-annotation-link-aa-action-residual-result.json"
V3014_ANNOTATION_LINK_AA_PRECEDENCE_RESIDUAL_JSON="$SCRATCH/v3014-annotation-link-aa-precedence-residual-result.json"
V3014_ATTACHMENT_ODD_NAMES_RESIDUAL_JSON="$SCRATCH/v3014-attachment-odd-names-residual-result.json"
V3014_ATTACHMENT_DUPKIDS_RESIDUAL_JSON="$SCRATCH/v3014-attachment-dupkids-residual-result.json"
...
V3014_OUTLINE_LAUNCH_RESIDUAL_JSON="$SCRATCH/v3014-outline-launch-residual-result.json"
V3014_OUTLINE_RELATIVE_REMOTE_RESIDUAL_JSON="$SCRATCH/v3014-outline-relative-remote-residual-result.json"
...
V3014_PAGE_GEOMETRY_USERUNIT_MULTIPAGE_RESIDUAL_JSON="$SCRATCH/v3014-page-geometry-userunit-multipage-residual-result.json"
...
bun "$REPO_ROOT/scripts/differential/capture-v3014-form-radio-as-no-override-residual-oracle.ts" 2>&1 | tee -a "$LOG"
bun "$REPO_ROOT/scripts/differential/check-v3014-form-radio-as-no-override-residual-differential.ts" \
  --output "$V3014_FORM_RADIO_AS_NO_OVERRIDE_RESIDUAL_JSON" >>"$LOG"
bun "$REPO_ROOT/scripts/differential/capture-v3014-form-checkbox-multi-export-residual-oracle.ts" 2>&1 | tee -a "$LOG"
bun "$REPO_ROOT/scripts/differential/check-v3014-form-checkbox-multi-export-residual-differential.ts" \
  --output "$V3014_FORM_CHECKBOX_MULTI_EXPORT_RESIDUAL_JSON" >>"$LOG"
bun "$REPO_ROOT/scripts/differential/capture-v3014-form-checkbox-multi-export-many-residual-oracle.ts" 2>&1 | tee -a "$LOG"
bun "$REPO_ROOT/scripts/differential/check-v3014-form-checkbox-multi-export-many-residual-differential.ts" \
  --output "$V3014_FORM_CHECKBOX_MULTI_EXPORT_MANY_RESIDUAL_JSON" >>"$LOG"
bun "$REPO_ROOT/scripts/differential/capture-v3014-form-checkbox-export-empty-single-residual-oracle.ts" 2>&1 | tee -a "$LOG"
bun "$REPO_ROOT/scripts/differential/check-v3014-form-checkbox-export-empty-single-residual-differential.ts" \
  --output "$V3014_FORM_CHECKBOX_EXPORT_EMPTY_SINGLE_RESIDUAL_JSON" >>"$LOG"
bun "$REPO_ROOT/scripts/differential/capture-v3014-form-checkbox-malformed-ap-residual-oracle.ts" 2>&1 | tee -a "$LOG"
bun "$REPO_ROOT/scripts/differential/check-v3014-form-checkbox-malformed-ap-residual-differential.ts" \
  --output "$V3014_FORM_CHECKBOX_MALFORMED_AP_RESIDUAL_JSON" >>"$LOG"
bun "$REPO_ROOT/scripts/differential/capture-v3014-form-radio-malformed-ap-residual-oracle.ts" 2>&1 | tee -a "$LOG"
bun "$REPO_ROOT/scripts/differential/check-v3014-form-radio-malformed-ap-residual-differential.ts" \
  --output "$V3014_FORM_RADIO_MALFORMED_AP_RESIDUAL_JSON" >>"$LOG"
bun "$REPO_ROOT/scripts/differential/capture-v3014-form-radio-parent-kids-ap-residual-oracle.ts" 2>&1 | tee -a "$LOG"
bun "$REPO_ROOT/scripts/differential/check-v3014-form-radio-parent-kids-ap-residual-differential.ts" \
  --output "$V3014_FORM_RADIO_PARENT_KIDS_AP_RESIDUAL_JSON" >>"$LOG"
bun "$REPO_ROOT/scripts/differential/capture-v3014-form-radio-deeper-kids-ap-residual-oracle.ts" 2>&1 | tee -a "$LOG"
bun "$REPO_ROOT/scripts/differential/check-v3014-form-radio-deeper-kids-ap-residual-differential.ts" \
  --output "$V3014_FORM_RADIO_DEEPER_KIDS_AP_RESIDUAL_JSON" >>"$LOG"
...
bun "$REPO_ROOT/scripts/differential/capture-v3014-annotation-freetext-rect-residual-oracle.ts" 2>&1 | tee -a "$LOG"
bun "$REPO_ROOT/scripts/differential/check-v3014-annotation-freetext-rect-residual-differential.ts" \
  --output "$V3014_ANNOTATION_FREETEXT_RECT_RESIDUAL_JSON" >>"$LOG"
bun "$REPO_ROOT/scripts/differential/capture-v3014-annotation-link-uri-name-residual-oracle.ts" 2>&1 | tee -a "$LOG"
bun "$REPO_ROOT/scripts/differential/check-v3014-annotation-link-uri-name-residual-differential.ts" \
  --output "$V3014_ANNOTATION_LINK_URI_NAME_RESIDUAL_JSON" >>"$LOG"
bun "$REPO_ROOT/scripts/differential/capture-v3014-annotation-link-aa-action-residual-oracle.ts" 2>&1 | tee -a "$LOG"
bun "$REPO_ROOT/scripts/differential/check-v3014-annotation-link-aa-action-residual-differential.ts" \
  --output "$V3014_ANNOTATION_LINK_AA_ACTION_RESIDUAL_JSON" >>"$LOG"
bun "$REPO_ROOT/scripts/differential/capture-v3014-annotation-link-aa-precedence-residual-oracle.ts" 2>&1 | tee -a "$LOG"
bun "$REPO_ROOT/scripts/differential/check-v3014-annotation-link-aa-precedence-residual-differential.ts" \
  --output "$V3014_ANNOTATION_LINK_AA_PRECEDENCE_RESIDUAL_JSON" >>"$LOG"
...
bun "$REPO_ROOT/scripts/differential/capture-v3014-attachment-dupkids-residual-oracle.ts" 2>&1 | tee -a "$LOG"
bun "$REPO_ROOT/scripts/differential/check-v3014-attachment-dupkids-residual-differential.ts" \
  --output "$V3014_ATTACHMENT_DUPKIDS_RESIDUAL_JSON" >>"$LOG"
...
bun "$REPO_ROOT/scripts/differential/capture-v3014-form-text-multiline-residual-oracle.ts" 2>&1 | tee -a "$LOG"
bun "$REPO_ROOT/scripts/differential/check-v3014-form-text-multiline-residual-differential.ts" \
  --output "$V3014_FORM_TEXT_MULTILINE_RESIDUAL_JSON" >>"$LOG"
...
bun "$REPO_ROOT/scripts/differential/capture-v3014-outline-launch-residual-oracle.ts" 2>&1 | tee -a "$LOG"
bun "$REPO_ROOT/scripts/differential/check-v3014-outline-launch-residual-differential.ts" \
  --output "$V3014_OUTLINE_LAUNCH_RESIDUAL_JSON" >>"$LOG"
bun "$REPO_ROOT/scripts/differential/capture-v3014-outline-relative-remote-residual-oracle.ts" 2>&1 | tee -a "$LOG"
bun "$REPO_ROOT/scripts/differential/check-v3014-outline-relative-remote-residual-differential.ts" \
  --output "$V3014_OUTLINE_RELATIVE_REMOTE_RESIDUAL_JSON" >>"$LOG"
...
bun "$REPO_ROOT/scripts/differential/capture-v3014-page-geometry-depth-clamp-residual-oracle.ts" 2>&1 | tee -a "$LOG"
bun "$REPO_ROOT/scripts/differential/check-v3014-page-geometry-depth-clamp-residual-differential.ts" \
  --output "$V3014_PAGE_GEOMETRY_DEPTH_CLAMP_RESIDUAL_JSON" >>"$LOG"
bun "$REPO_ROOT/scripts/differential/capture-v3014-page-geometry-userunit-multipage-residual-oracle.ts" 2>&1 | tee -a "$LOG"
bun "$REPO_ROOT/scripts/differential/check-v3014-page-geometry-userunit-multipage-residual-differential.ts" \
  --output "$V3014_PAGE_GEOMETRY_USERUNIT_MULTIPAGE_RESIDUAL_JSON" >>"$LOG"
...
BEHAVIOR_SPEC_HASH="$(sha256sum \
  ...
  "$REPO_ROOT/scripts/differential/check-v3014-attachment-dupkids-residual-differential.ts" \
  "$REPO_ROOT/scripts/differential/capture-v3014-attachment-dupkids-residual-oracle.ts" \
  "$REPO_ROOT/scripts/differential/v3014-attachment-dupkids-residual-baseline-runner.ts" \
  "$REPO_ROOT/scripts/differential/v3014-attachment-dupkids-residual-projection.ts" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-attachment-dupkids-residual-corpus.json" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-attachment-dupkids-residual-oracle.json" \
  "$REPO_ROOT/test/fixtures/differential/v3014-attachment-dupkids-control-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-attachment-dupkids-duplicate-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-attachment-dupkids-cycle-v1.pdf" \
  ...
  "$REPO_ROOT/scripts/differential/v3014-form-radio-as-no-override-residual-baseline-runner.ts" \
  "$REPO_ROOT/scripts/differential/v3014-form-radio-as-no-override-residual-projection.ts" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-form-radio-as-no-override-residual-corpus.json" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-form-radio-as-no-override-residual-oracle.json" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-radio-as-does-not-override-v-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-radio-as-invalid-keeps-v-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-radio-checkbox-as-regression-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-radio-as-does-not-override-v-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-radio-as-invalid-keeps-v-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-radio-checkbox-as-regression-v1.pdf" \
  "$REPO_ROOT/scripts/differential/v3014-form-checkbox-multi-export-residual-baseline-runner.ts" \
  "$REPO_ROOT/scripts/differential/v3014-form-checkbox-multi-export-residual-projection.ts" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-form-checkbox-multi-export-residual-corpus.json" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-form-checkbox-multi-export-residual-oracle.json" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-checkbox-multi-export-foo-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-checkbox-multi-export-as-bar-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-checkbox-multi-export-as-baz-off-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-checkbox-multi-export-foo-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-checkbox-multi-export-as-bar-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-checkbox-multi-export-as-baz-off-v1.pdf" \
  "$REPO_ROOT/scripts/differential/v3014-form-checkbox-multi-export-many-residual-baseline-runner.ts" \
  "$REPO_ROOT/scripts/differential/v3014-form-checkbox-multi-export-many-residual-projection.ts" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-form-checkbox-multi-export-many-residual-corpus.json" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-form-checkbox-multi-export-many-residual-oracle.json" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-checkbox-multi-export-many-c-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-checkbox-multi-export-many-a-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-checkbox-multi-export-many-z-off-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-checkbox-multi-export-many-c-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-checkbox-multi-export-many-a-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-checkbox-multi-export-many-z-off-v1.pdf" \
  "$REPO_ROOT/scripts/differential/v3014-form-checkbox-export-empty-single-residual-baseline-runner.ts" \
  "$REPO_ROOT/scripts/differential/v3014-form-checkbox-export-empty-single-residual-projection.ts" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-form-checkbox-export-empty-single-residual-corpus.json" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-form-checkbox-export-empty-single-residual-oracle.json" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-checkbox-export-empty-ap-yes-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-checkbox-export-single-foo-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-checkbox-export-single-bar-off-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-checkbox-export-empty-ap-yes-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-checkbox-export-single-foo-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-checkbox-export-single-bar-off-v1.pdf" \
  "$REPO_ROOT/scripts/differential/v3014-form-checkbox-malformed-ap-residual-baseline-runner.ts" \
  "$REPO_ROOT/scripts/differential/v3014-form-checkbox-malformed-ap-residual-projection.ts" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-form-checkbox-malformed-ap-residual-corpus.json" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-form-checkbox-malformed-ap-residual-oracle.json" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-checkbox-ap-stream-keeps-v-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-checkbox-apn-stream-keeps-v-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-checkbox-ap-named-as-off-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-checkbox-ap-stream-keeps-v-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-checkbox-apn-stream-keeps-v-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-checkbox-ap-named-as-off-v1.pdf" \
  "$REPO_ROOT/scripts/differential/v3014-form-radio-malformed-ap-residual-baseline-runner.ts" \
  "$REPO_ROOT/scripts/differential/v3014-form-radio-malformed-ap-residual-projection.ts" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-form-radio-malformed-ap-residual-corpus.json" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-form-radio-malformed-ap-residual-oracle.json" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-radio-ap-stream-keeps-v-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-radio-apn-stream-keeps-v-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-radio-ap-named-keeps-v-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-radio-ap-stream-keeps-v-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-radio-apn-stream-keeps-v-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-radio-ap-named-keeps-v-v1.pdf" \
  "$REPO_ROOT/scripts/differential/v3014-form-radio-parent-kids-ap-residual-baseline-runner.ts" \
  "$REPO_ROOT/scripts/differential/v3014-form-radio-parent-kids-ap-residual-projection.ts" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-form-radio-parent-kids-ap-residual-corpus.json" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-form-radio-parent-kids-ap-residual-oracle.json" \
  "$REPO_ROOT/scripts/differential/v3014-form-radio-deeper-kids-ap-residual-baseline-runner.ts" \
  "$REPO_ROOT/scripts/differential/v3014-form-radio-deeper-kids-ap-residual-projection.ts" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-form-radio-deeper-kids-ap-residual-corpus.json" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-form-radio-deeper-kids-ap-residual-oracle.json" \
  "$REPO_ROOT/scripts/differential/v3014-form-radio-broken-parent-chain-residual-baseline-runner.ts" \
  ...
  "$REPO_ROOT/scripts/differential/v3014-annotation-square-circle-widget-residual-baseline-runner.ts" \
  ...
  "$REPO_ROOT/scripts/differential/v3014-annotation-freetext-rect-residual-baseline-runner.ts" \
  "$REPO_ROOT/scripts/differential/v3014-annotation-freetext-rect-residual-projection.ts" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-annotation-freetext-rect-residual-corpus.json" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-annotation-freetext-rect-residual-oracle.json" \
  "$REPO_ROOT/scripts/differential/v3014-annotation-link-uri-name-residual-baseline-runner.ts" \
  "$REPO_ROOT/scripts/differential/v3014-annotation-link-uri-name-residual-projection.ts" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-annotation-link-uri-name-residual-corpus.json" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-annotation-link-uri-name-residual-oracle.json" \
  "$REPO_ROOT/scripts/differential/v3014-annotation-link-aa-action-residual-baseline-runner.ts" \
  "$REPO_ROOT/scripts/differential/v3014-annotation-link-aa-action-residual-projection.ts" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-annotation-link-aa-action-residual-corpus.json" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-annotation-link-aa-action-residual-oracle.json" \
  "$REPO_ROOT/scripts/differential/v3014-annotation-link-aa-precedence-residual-baseline-runner.ts" \
  "$REPO_ROOT/scripts/differential/v3014-annotation-link-aa-precedence-residual-projection.ts" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-annotation-link-aa-precedence-residual-corpus.json" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-annotation-link-aa-precedence-residual-oracle.json" \
  ...
  "$REPO_ROOT/scripts/differential/check-v3014-form-text-multiline-residual-differential.ts" \
  "$REPO_ROOT/scripts/differential/capture-v3014-form-text-multiline-residual-oracle.ts" \
  "$REPO_ROOT/scripts/differential/v3014-form-text-multiline-residual-baseline-runner.ts" \
  "$REPO_ROOT/scripts/differential/v3014-form-text-multiline-residual-projection.ts" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-form-text-multiline-residual-corpus.json" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-form-text-multiline-residual-oracle.json" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-text-multiline-lf-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-text-multiline-crlf-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-form-text-multiline-rawlf-v1.pdf" \
  "$REPO_ROOT/scripts/differential/check-v3014-annotation-contents-multiline-residual-differential.ts" \
  "$REPO_ROOT/scripts/differential/capture-v3014-annotation-contents-multiline-residual-oracle.ts" \
  "$REPO_ROOT/scripts/differential/v3014-annotation-contents-multiline-residual-baseline-runner.ts" \
  "$REPO_ROOT/scripts/differential/v3014-annotation-contents-multiline-residual-projection.ts" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-annotation-contents-multiline-residual-corpus.json" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-annotation-contents-multiline-residual-oracle.json" \
  ...
  "$REPO_ROOT/scripts/differential/check-v3014-outline-named-dest-residual-differential.ts" \
  "$REPO_ROOT/scripts/differential/capture-v3014-outline-named-dest-residual-oracle.ts" \
  "$REPO_ROOT/scripts/differential/v3014-outline-named-dest-residual-baseline-runner.ts" \
  "$REPO_ROOT/scripts/differential/v3014-outline-named-dest-residual-projection.ts" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-outline-named-dest-residual-corpus.json" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-outline-named-dest-residual-oracle.json" \
  ...
  "$REPO_ROOT/scripts/differential/check-v3014-outline-launch-residual-differential.ts" \
  "$REPO_ROOT/scripts/differential/capture-v3014-outline-launch-residual-oracle.ts" \
  "$REPO_ROOT/scripts/differential/v3014-outline-launch-residual-baseline-runner.ts" \
  "$REPO_ROOT/scripts/differential/v3014-outline-launch-residual-projection.ts" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-outline-launch-residual-corpus.json" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-outline-launch-residual-oracle.json" \
  "$REPO_ROOT/test/fixtures/differential/v3014-outline-launch-string-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-outline-launch-filespec-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-outline-launch-explicit-v1.pdf" \
  "$REPO_ROOT/scripts/differential/check-v3014-outline-relative-remote-residual-differential.ts" \
  "$REPO_ROOT/scripts/differential/capture-v3014-outline-relative-remote-residual-oracle.ts" \
  "$REPO_ROOT/scripts/differential/v3014-outline-relative-remote-residual-baseline-runner.ts" \
  "$REPO_ROOT/scripts/differential/v3014-outline-relative-remote-residual-projection.ts" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-outline-relative-remote-residual-corpus.json" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-outline-relative-remote-residual-oracle.json" \
  "$REPO_ROOT/test/fixtures/differential/v3014-outline-relative-gotor-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-outline-relative-launch-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-outline-relative-launch-dest-v1.pdf" \
  ...
  "$REPO_ROOT/scripts/differential/v3014-info-trapped-custom-residual-projection.ts" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-info-trapped-custom-residual-corpus.json" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-info-trapped-custom-residual-oracle.json" \
  ...
  "$REPO_ROOT/scripts/differential/check-v3014-page-geometry-depth-clamp-residual-differential.ts" \
  "$REPO_ROOT/scripts/differential/capture-v3014-page-geometry-depth-clamp-residual-oracle.ts" \
  "$REPO_ROOT/scripts/differential/v3014-page-geometry-depth-clamp-residual-baseline-runner.ts" \
  "$REPO_ROOT/scripts/differential/v3014-page-geometry-depth-clamp-residual-projection.ts" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-page-geometry-depth-clamp-residual-corpus.json" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-page-geometry-depth-clamp-residual-oracle.json" \
  "$REPO_ROOT/test/fixtures/differential/v3014-page-geometry-deeper-inherit-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-page-geometry-non-right-angle-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-page-geometry-crop-intersect-v1.pdf" \
  "$REPO_ROOT/scripts/differential/check-v3014-page-geometry-userunit-multipage-residual-differential.ts" \
  "$REPO_ROOT/scripts/differential/capture-v3014-page-geometry-userunit-multipage-residual-oracle.ts" \
  "$REPO_ROOT/scripts/differential/v3014-page-geometry-userunit-multipage-residual-baseline-runner.ts" \
  "$REPO_ROOT/scripts/differential/v3014-page-geometry-userunit-multipage-residual-projection.ts" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-page-geometry-userunit-multipage-residual-corpus.json" \
  "$REPO_ROOT/scripts/differential/fixtures/v3014-page-geometry-userunit-multipage-residual-oracle.json" \
  "$REPO_ROOT/test/fixtures/differential/v3014-page-geometry-userunit-pages-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-page-geometry-multi-page-v1.pdf" \
  "$REPO_ROOT/test/fixtures/differential/v3014-page-geometry-bleed-ignore-v1.pdf" \
...
V3014_FORM_RADIO_AS_NO_OVERRIDE_RESIDUAL_CASE_COUNT="$(jq '.caseCount' "$V3014_FORM_RADIO_AS_NO_OVERRIDE_RESIDUAL_JSON")"
V3014_FORM_RADIO_AS_NO_OVERRIDE_RESIDUAL_PASSED="$(jq '.passed' "$V3014_FORM_RADIO_AS_NO_OVERRIDE_RESIDUAL_JSON")"
V3014_FORM_RADIO_AS_NO_OVERRIDE_RESIDUAL_SKIPPED="$(jq '.skipped' "$V3014_FORM_RADIO_AS_NO_OVERRIDE_RESIDUAL_JSON")"
V3014_FORM_RADIO_AS_NO_OVERRIDE_RESIDUAL_CORPUS_HASH="$(jq -r '.corpusSha256' "$V3014_FORM_RADIO_AS_NO_OVERRIDE_RESIDUAL_JSON")"
V3014_FORM_RADIO_AS_NO_OVERRIDE_RESIDUAL_ORACLE_HASH="$(jq -r '.oracleSha256' "$V3014_FORM_RADIO_AS_NO_OVERRIDE_RESIDUAL_JSON")"
V3014_FORM_CHECKBOX_MULTI_EXPORT_RESIDUAL_CASE_COUNT="$(jq '.caseCount' "$V3014_FORM_CHECKBOX_MULTI_EXPORT_RESIDUAL_JSON")"
V3014_FORM_CHECKBOX_MULTI_EXPORT_RESIDUAL_PASSED="$(jq '.passed' "$V3014_FORM_CHECKBOX_MULTI_EXPORT_RESIDUAL_JSON")"
V3014_FORM_CHECKBOX_MULTI_EXPORT_RESIDUAL_SKIPPED="$(jq '.skipped' "$V3014_FORM_CHECKBOX_MULTI_EXPORT_RESIDUAL_JSON")"
V3014_FORM_CHECKBOX_MULTI_EXPORT_RESIDUAL_CORPUS_HASH="$(jq -r '.corpusSha256' "$V3014_FORM_CHECKBOX_MULTI_EXPORT_RESIDUAL_JSON")"
V3014_FORM_CHECKBOX_MULTI_EXPORT_RESIDUAL_ORACLE_HASH="$(jq -r '.oracleSha256' "$V3014_FORM_CHECKBOX_MULTI_EXPORT_RESIDUAL_JSON")"
V3014_FORM_CHECKBOX_MULTI_EXPORT_MANY_RESIDUAL_CASE_COUNT="$(jq '.caseCount' "$V3014_FORM_CHECKBOX_MULTI_EXPORT_MANY_RESIDUAL_JSON")"
V3014_FORM_CHECKBOX_MULTI_EXPORT_MANY_RESIDUAL_PASSED="$(jq '.passed' "$V3014_FORM_CHECKBOX_MULTI_EXPORT_MANY_RESIDUAL_JSON")"
V3014_FORM_CHECKBOX_MULTI_EXPORT_MANY_RESIDUAL_SKIPPED="$(jq '.skipped' "$V3014_FORM_CHECKBOX_MULTI_EXPORT_MANY_RESIDUAL_JSON")"
V3014_FORM_CHECKBOX_MULTI_EXPORT_MANY_RESIDUAL_CORPUS_HASH="$(jq -r '.corpusSha256' "$V3014_FORM_CHECKBOX_MULTI_EXPORT_MANY_RESIDUAL_JSON")"
V3014_FORM_CHECKBOX_MULTI_EXPORT_MANY_RESIDUAL_ORACLE_HASH="$(jq -r '.oracleSha256' "$V3014_FORM_CHECKBOX_MULTI_EXPORT_MANY_RESIDUAL_JSON")"
V3014_FORM_CHECKBOX_EXPORT_EMPTY_SINGLE_RESIDUAL_CASE_COUNT="$(jq '.caseCount' "$V3014_FORM_CHECKBOX_EXPORT_EMPTY_SINGLE_RESIDUAL_JSON")"
V3014_FORM_CHECKBOX_EXPORT_EMPTY_SINGLE_RESIDUAL_PASSED="$(jq '.passed' "$V3014_FORM_CHECKBOX_EXPORT_EMPTY_SINGLE_RESIDUAL_JSON")"
V3014_FORM_CHECKBOX_EXPORT_EMPTY_SINGLE_RESIDUAL_SKIPPED="$(jq '.skipped' "$V3014_FORM_CHECKBOX_EXPORT_EMPTY_SINGLE_RESIDUAL_JSON")"
V3014_FORM_CHECKBOX_EXPORT_EMPTY_SINGLE_RESIDUAL_CORPUS_HASH="$(jq -r '.corpusSha256' "$V3014_FORM_CHECKBOX_EXPORT_EMPTY_SINGLE_RESIDUAL_JSON")"
V3014_FORM_CHECKBOX_EXPORT_EMPTY_SINGLE_RESIDUAL_ORACLE_HASH="$(jq -r '.oracleSha256' "$V3014_FORM_CHECKBOX_EXPORT_EMPTY_SINGLE_RESIDUAL_JSON")"
V3014_FORM_CHECKBOX_MALFORMED_AP_RESIDUAL_CASE_COUNT="$(jq '.caseCount' "$V3014_FORM_CHECKBOX_MALFORMED_AP_RESIDUAL_JSON")"
V3014_FORM_CHECKBOX_MALFORMED_AP_RESIDUAL_PASSED="$(jq '.passed' "$V3014_FORM_CHECKBOX_MALFORMED_AP_RESIDUAL_JSON")"
V3014_FORM_CHECKBOX_MALFORMED_AP_RESIDUAL_SKIPPED="$(jq '.skipped' "$V3014_FORM_CHECKBOX_MALFORMED_AP_RESIDUAL_JSON")"
V3014_FORM_CHECKBOX_MALFORMED_AP_RESIDUAL_CORPUS_HASH="$(jq -r '.corpusSha256' "$V3014_FORM_CHECKBOX_MALFORMED_AP_RESIDUAL_JSON")"
V3014_FORM_CHECKBOX_MALFORMED_AP_RESIDUAL_ORACLE_HASH="$(jq -r '.oracleSha256' "$V3014_FORM_CHECKBOX_MALFORMED_AP_RESIDUAL_JSON")"
V3014_FORM_RADIO_MALFORMED_AP_RESIDUAL_CASE_COUNT="$(jq '.caseCount' "$V3014_FORM_RADIO_MALFORMED_AP_RESIDUAL_JSON")"
V3014_FORM_RADIO_MALFORMED_AP_RESIDUAL_PASSED="$(jq '.passed' "$V3014_FORM_RADIO_MALFORMED_AP_RESIDUAL_JSON")"
V3014_FORM_RADIO_MALFORMED_AP_RESIDUAL_SKIPPED="$(jq '.skipped' "$V3014_FORM_RADIO_MALFORMED_AP_RESIDUAL_JSON")"
V3014_FORM_RADIO_MALFORMED_AP_RESIDUAL_CORPUS_HASH="$(jq -r '.corpusSha256' "$V3014_FORM_RADIO_MALFORMED_AP_RESIDUAL_JSON")"
V3014_FORM_RADIO_MALFORMED_AP_RESIDUAL_ORACLE_HASH="$(jq -r '.oracleSha256' "$V3014_FORM_RADIO_MALFORMED_AP_RESIDUAL_JSON")"
V3014_FORM_RADIO_PARENT_KIDS_AP_RESIDUAL_CASE_COUNT="$(jq '.caseCount' "$V3014_FORM_RADIO_PARENT_KIDS_AP_RESIDUAL_JSON")"
V3014_FORM_RADIO_PARENT_KIDS_AP_RESIDUAL_PASSED="$(jq '.passed' "$V3014_FORM_RADIO_PARENT_KIDS_AP_RESIDUAL_JSON")"
V3014_FORM_RADIO_PARENT_KIDS_AP_RESIDUAL_SKIPPED="$(jq '.skipped' "$V3014_FORM_RADIO_PARENT_KIDS_AP_RESIDUAL_JSON")"
V3014_FORM_RADIO_PARENT_KIDS_AP_RESIDUAL_CORPUS_HASH="$(jq -r '.corpusSha256' "$V3014_FORM_RADIO_PARENT_KIDS_AP_RESIDUAL_JSON")"
V3014_FORM_RADIO_PARENT_KIDS_AP_RESIDUAL_ORACLE_HASH="$(jq -r '.oracleSha256' "$V3014_FORM_RADIO_PARENT_KIDS_AP_RESIDUAL_JSON")"
V3014_FORM_RADIO_DEEPER_KIDS_AP_RESIDUAL_CASE_COUNT="$(jq '.caseCount' "$V3014_FORM_RADIO_DEEPER_KIDS_AP_RESIDUAL_JSON")"
V3014_FORM_RADIO_DEEPER_KIDS_AP_RESIDUAL_PASSED="$(jq '.passed' "$V3014_FORM_RADIO_DEEPER_KIDS_AP_RESIDUAL_JSON")"
V3014_FORM_RADIO_DEEPER_KIDS_AP_RESIDUAL_SKIPPED="$(jq '.skipped' "$V3014_FORM_RADIO_DEEPER_KIDS_AP_RESIDUAL_JSON")"
V3014_FORM_RADIO_DEEPER_KIDS_AP_RESIDUAL_CORPUS_HASH="$(jq -r '.corpusSha256' "$V3014_FORM_RADIO_DEEPER_KIDS_AP_RESIDUAL_JSON")"
V3014_FORM_RADIO_DEEPER_KIDS_AP_RESIDUAL_ORACLE_HASH="$(jq -r '.oracleSha256' "$V3014_FORM_RADIO_DEEPER_KIDS_AP_RESIDUAL_JSON")"
V3014_FORM_RADIO_BROKEN_PARENT_CHAIN_RESIDUAL_CASE_COUNT="$(jq '.caseCount' "$V3014_FORM_RADIO_BROKEN_PARENT_CHAIN_RESIDUAL_JSON")"
V3014_FORM_RADIO_BROKEN_PARENT_CHAIN_RESIDUAL_PASSED="$(jq '.passed' "$V3014_FORM_RADIO_BROKEN_PARENT_CHAIN_RESIDUAL_JSON")"
...
V3014_ANNOTATION_SQUARE_CIRCLE_WIDGET_RESIDUAL_CASE_COUNT="$(jq '.caseCount' "$V3014_ANNOTATION_SQUARE_CIRCLE_WIDGET_RESIDUAL_JSON")"
V3014_ANNOTATION_SQUARE_CIRCLE_WIDGET_RESIDUAL_PASSED="$(jq '.passed' "$V3014_ANNOTATION_SQUARE_CIRCLE_WIDGET_RESIDUAL_JSON")"
...
V3014_ANNOTATION_FREETEXT_RECT_RESIDUAL_CASE_COUNT="$(jq '.caseCount' "$V3014_ANNOTATION_FREETEXT_RECT_RESIDUAL_JSON")"
V3014_ANNOTATION_FREETEXT_RECT_RESIDUAL_PASSED="$(jq '.passed' "$V3014_ANNOTATION_FREETEXT_RECT_RESIDUAL_JSON")"
V3014_ANNOTATION_FREETEXT_RECT_RESIDUAL_SKIPPED="$(jq '.skipped' "$V3014_ANNOTATION_FREETEXT_RECT_RESIDUAL_JSON")"
V3014_ANNOTATION_FREETEXT_RECT_RESIDUAL_CORPUS_HASH="$(jq -r '.corpusSha256' "$V3014_ANNOTATION_FREETEXT_RECT_RESIDUAL_JSON")"
V3014_ANNOTATION_FREETEXT_RECT_RESIDUAL_ORACLE_HASH="$(jq -r '.oracleSha256' "$V3014_ANNOTATION_FREETEXT_RECT_RESIDUAL_JSON")"
V3014_ANNOTATION_LINK_URI_NAME_RESIDUAL_CASE_COUNT="$(jq '.caseCount' "$V3014_ANNOTATION_LINK_URI_NAME_RESIDUAL_JSON")"
V3014_ANNOTATION_LINK_URI_NAME_RESIDUAL_PASSED="$(jq '.passed' "$V3014_ANNOTATION_LINK_URI_NAME_RESIDUAL_JSON")"
V3014_ANNOTATION_LINK_URI_NAME_RESIDUAL_SKIPPED="$(jq '.skipped' "$V3014_ANNOTATION_LINK_URI_NAME_RESIDUAL_JSON")"
V3014_ANNOTATION_LINK_URI_NAME_RESIDUAL_CORPUS_HASH="$(jq -r '.corpusSha256' "$V3014_ANNOTATION_LINK_URI_NAME_RESIDUAL_JSON")"
V3014_ANNOTATION_LINK_URI_NAME_RESIDUAL_ORACLE_HASH="$(jq -r '.oracleSha256' "$V3014_ANNOTATION_LINK_URI_NAME_RESIDUAL_JSON")"
V3014_ANNOTATION_LINK_AA_ACTION_RESIDUAL_CASE_COUNT="$(jq '.caseCount' "$V3014_ANNOTATION_LINK_AA_ACTION_RESIDUAL_JSON")"
V3014_ANNOTATION_LINK_AA_ACTION_RESIDUAL_PASSED="$(jq '.passed' "$V3014_ANNOTATION_LINK_AA_ACTION_RESIDUAL_JSON")"
V3014_ANNOTATION_LINK_AA_ACTION_RESIDUAL_SKIPPED="$(jq '.skipped' "$V3014_ANNOTATION_LINK_AA_ACTION_RESIDUAL_JSON")"
V3014_ANNOTATION_LINK_AA_ACTION_RESIDUAL_CORPUS_HASH="$(jq -r '.corpusSha256' "$V3014_ANNOTATION_LINK_AA_ACTION_RESIDUAL_JSON")"
V3014_ANNOTATION_LINK_AA_ACTION_RESIDUAL_ORACLE_HASH="$(jq -r '.oracleSha256' "$V3014_ANNOTATION_LINK_AA_ACTION_RESIDUAL_JSON")"
V3014_ANNOTATION_LINK_AA_PRECEDENCE_RESIDUAL_CASE_COUNT="$(jq '.caseCount' "$V3014_ANNOTATION_LINK_AA_PRECEDENCE_RESIDUAL_JSON")"
V3014_ANNOTATION_LINK_AA_PRECEDENCE_RESIDUAL_PASSED="$(jq '.passed' "$V3014_ANNOTATION_LINK_AA_PRECEDENCE_RESIDUAL_JSON")"
V3014_ANNOTATION_LINK_AA_PRECEDENCE_RESIDUAL_SKIPPED="$(jq '.skipped' "$V3014_ANNOTATION_LINK_AA_PRECEDENCE_RESIDUAL_JSON")"
V3014_ANNOTATION_LINK_AA_PRECEDENCE_RESIDUAL_CORPUS_HASH="$(jq -r '.corpusSha256' "$V3014_ANNOTATION_LINK_AA_PRECEDENCE_RESIDUAL_JSON")"
V3014_ANNOTATION_LINK_AA_PRECEDENCE_RESIDUAL_ORACLE_HASH="$(jq -r '.oracleSha256' "$V3014_ANNOTATION_LINK_AA_PRECEDENCE_RESIDUAL_JSON")"
...
V3014_ATTACHMENT_DUPKIDS_RESIDUAL_CASE_COUNT="$(jq '.caseCount' "$V3014_ATTACHMENT_DUPKIDS_RESIDUAL_JSON")"
V3014_ATTACHMENT_DUPKIDS_RESIDUAL_PASSED="$(jq '.passed' "$V3014_ATTACHMENT_DUPKIDS_RESIDUAL_JSON")"
V3014_ATTACHMENT_DUPKIDS_RESIDUAL_SKIPPED="$(jq '.skipped' "$V3014_ATTACHMENT_DUPKIDS_RESIDUAL_JSON")"
V3014_ATTACHMENT_DUPKIDS_RESIDUAL_CORPUS_HASH="$(jq -r '.corpusSha256' "$V3014_ATTACHMENT_DUPKIDS_RESIDUAL_JSON")"
V3014_ATTACHMENT_DUPKIDS_RESIDUAL_ORACLE_HASH="$(jq -r '.oracleSha256' "$V3014_ATTACHMENT_DUPKIDS_RESIDUAL_JSON")"
...
V3014_FORM_TEXT_MULTILINE_RESIDUAL_CASE_COUNT="$(jq '.caseCount' "$V3014_FORM_TEXT_MULTILINE_RESIDUAL_JSON")"
V3014_FORM_TEXT_MULTILINE_RESIDUAL_PASSED="$(jq '.passed' "$V3014_FORM_TEXT_MULTILINE_RESIDUAL_JSON")"
V3014_FORM_TEXT_MULTILINE_RESIDUAL_SKIPPED="$(jq '.skipped' "$V3014_FORM_TEXT_MULTILINE_RESIDUAL_JSON")"
V3014_FORM_TEXT_MULTILINE_RESIDUAL_CORPUS_HASH="$(jq -r '.corpusSha256' "$V3014_FORM_TEXT_MULTILINE_RESIDUAL_JSON")"
V3014_FORM_TEXT_MULTILINE_RESIDUAL_ORACLE_HASH="$(jq -r '.oracleSha256' "$V3014_FORM_TEXT_MULTILINE_RESIDUAL_JSON")"
V3014_ANNOTATION_CONTENTS_MULTILINE_RESIDUAL_CASE_COUNT="$(jq '.caseCount' "$V3014_ANNOTATION_CONTENTS_MULTILINE_RESIDUAL_JSON")"
V3014_ANNOTATION_CONTENTS_MULTILINE_RESIDUAL_PASSED="$(jq '.passed' "$V3014_ANNOTATION_CONTENTS_MULTILINE_RESIDUAL_JSON")"
...
V3014_OUTLINE_NAMED_DEST_RESIDUAL_CASE_COUNT="$(jq '.caseCount' "$V3014_OUTLINE_NAMED_DEST_RESIDUAL_JSON")"
V3014_OUTLINE_NAMED_DEST_RESIDUAL_PASSED="$(jq '.passed' "$V3014_OUTLINE_NAMED_DEST_RESIDUAL_JSON")"
...
V3014_OUTLINE_LAUNCH_RESIDUAL_CASE_COUNT="$(jq '.caseCount' "$V3014_OUTLINE_LAUNCH_RESIDUAL_JSON")"
V3014_OUTLINE_LAUNCH_RESIDUAL_PASSED="$(jq '.passed' "$V3014_OUTLINE_LAUNCH_RESIDUAL_JSON")"
V3014_OUTLINE_LAUNCH_RESIDUAL_SKIPPED="$(jq '.skipped' "$V3014_OUTLINE_LAUNCH_RESIDUAL_JSON")"
V3014_OUTLINE_LAUNCH_RESIDUAL_CORPUS_HASH="$(jq -r '.corpusSha256' "$V3014_OUTLINE_LAUNCH_RESIDUAL_JSON")"
V3014_OUTLINE_LAUNCH_RESIDUAL_ORACLE_HASH="$(jq -r '.oracleSha256' "$V3014_OUTLINE_LAUNCH_RESIDUAL_JSON")"
V3014_OUTLINE_RELATIVE_REMOTE_RESIDUAL_CASE_COUNT="$(jq '.caseCount' "$V3014_OUTLINE_RELATIVE_REMOTE_RESIDUAL_JSON")"
V3014_OUTLINE_RELATIVE_REMOTE_RESIDUAL_PASSED="$(jq '.passed' "$V3014_OUTLINE_RELATIVE_REMOTE_RESIDUAL_JSON")"
V3014_OUTLINE_RELATIVE_REMOTE_RESIDUAL_SKIPPED="$(jq '.skipped' "$V3014_OUTLINE_RELATIVE_REMOTE_RESIDUAL_JSON")"
V3014_OUTLINE_RELATIVE_REMOTE_RESIDUAL_CORPUS_HASH="$(jq -r '.corpusSha256' "$V3014_OUTLINE_RELATIVE_REMOTE_RESIDUAL_JSON")"
V3014_OUTLINE_RELATIVE_REMOTE_RESIDUAL_ORACLE_HASH="$(jq -r '.oracleSha256' "$V3014_OUTLINE_RELATIVE_REMOTE_RESIDUAL_JSON")"
...
V3014_PAGE_GEOMETRY_DEPTH_CLAMP_RESIDUAL_CASE_COUNT="$(jq '.caseCount' "$V3014_PAGE_GEOMETRY_DEPTH_CLAMP_RESIDUAL_JSON")"
V3014_PAGE_GEOMETRY_DEPTH_CLAMP_RESIDUAL_PASSED="$(jq '.passed' "$V3014_PAGE_GEOMETRY_DEPTH_CLAMP_RESIDUAL_JSON")"
V3014_PAGE_GEOMETRY_DEPTH_CLAMP_RESIDUAL_SKIPPED="$(jq '.skipped' "$V3014_PAGE_GEOMETRY_DEPTH_CLAMP_RESIDUAL_JSON")"
V3014_PAGE_GEOMETRY_DEPTH_CLAMP_RESIDUAL_CORPUS_HASH="$(jq -r '.corpusSha256' "$V3014_PAGE_GEOMETRY_DEPTH_CLAMP_RESIDUAL_JSON")"
V3014_PAGE_GEOMETRY_DEPTH_CLAMP_RESIDUAL_ORACLE_HASH="$(jq -r '.oracleSha256' "$V3014_PAGE_GEOMETRY_DEPTH_CLAMP_RESIDUAL_JSON")"
V3014_PAGE_GEOMETRY_USERUNIT_MULTIPAGE_RESIDUAL_CASE_COUNT="$(jq '.caseCount' "$V3014_PAGE_GEOMETRY_USERUNIT_MULTIPAGE_RESIDUAL_JSON")"
V3014_PAGE_GEOMETRY_USERUNIT_MULTIPAGE_RESIDUAL_PASSED="$(jq '.passed' "$V3014_PAGE_GEOMETRY_USERUNIT_MULTIPAGE_RESIDUAL_JSON")"
V3014_PAGE_GEOMETRY_USERUNIT_MULTIPAGE_RESIDUAL_SKIPPED="$(jq '.skipped' "$V3014_PAGE_GEOMETRY_USERUNIT_MULTIPAGE_RESIDUAL_JSON")"
V3014_PAGE_GEOMETRY_USERUNIT_MULTIPAGE_RESIDUAL_CORPUS_HASH="$(jq -r '.corpusSha256' "$V3014_PAGE_GEOMETRY_USERUNIT_MULTIPAGE_RESIDUAL_JSON")"
V3014_PAGE_GEOMETRY_USERUNIT_MULTIPAGE_RESIDUAL_ORACLE_HASH="$(jq -r '.oracleSha256' "$V3014_PAGE_GEOMETRY_USERUNIT_MULTIPAGE_RESIDUAL_JSON")"
...
jq -n \
  ...
  --arg v3014FormRadioAsNoOverrideResidualCorpusHash "$V3014_FORM_RADIO_AS_NO_OVERRIDE_RESIDUAL_CORPUS_HASH" \
  --arg v3014FormRadioAsNoOverrideResidualOracleHash "$V3014_FORM_RADIO_AS_NO_OVERRIDE_RESIDUAL_ORACLE_HASH" \
  --arg v3014FormCheckboxMultiExportResidualCorpusHash "$V3014_FORM_CHECKBOX_MULTI_EXPORT_RESIDUAL_CORPUS_HASH" \
  --arg v3014FormCheckboxMultiExportResidualOracleHash "$V3014_FORM_CHECKBOX_MULTI_EXPORT_RESIDUAL_ORACLE_HASH" \
  --arg v3014FormCheckboxMultiExportManyResidualCorpusHash "$V3014_FORM_CHECKBOX_MULTI_EXPORT_MANY_RESIDUAL_CORPUS_HASH" \
  --arg v3014FormCheckboxMultiExportManyResidualOracleHash "$V3014_FORM_CHECKBOX_MULTI_EXPORT_MANY_RESIDUAL_ORACLE_HASH" \
  --arg v3014FormCheckboxExportEmptySingleResidualCorpusHash "$V3014_FORM_CHECKBOX_EXPORT_EMPTY_SINGLE_RESIDUAL_CORPUS_HASH" \
  --arg v3014FormCheckboxExportEmptySingleResidualOracleHash "$V3014_FORM_CHECKBOX_EXPORT_EMPTY_SINGLE_RESIDUAL_ORACLE_HASH" \
  --arg v3014FormCheckboxMalformedApResidualCorpusHash "$V3014_FORM_CHECKBOX_MALFORMED_AP_RESIDUAL_CORPUS_HASH" \
  --arg v3014FormCheckboxMalformedApResidualOracleHash "$V3014_FORM_CHECKBOX_MALFORMED_AP_RESIDUAL_ORACLE_HASH" \
  --arg v3014FormRadioMalformedApResidualCorpusHash "$V3014_FORM_RADIO_MALFORMED_AP_RESIDUAL_CORPUS_HASH" \
  --arg v3014FormRadioMalformedApResidualOracleHash "$V3014_FORM_RADIO_MALFORMED_AP_RESIDUAL_ORACLE_HASH" \
  --arg v3014FormRadioParentKidsApResidualCorpusHash "$V3014_FORM_RADIO_PARENT_KIDS_AP_RESIDUAL_CORPUS_HASH" \
  --arg v3014FormRadioParentKidsApResidualOracleHash "$V3014_FORM_RADIO_PARENT_KIDS_AP_RESIDUAL_ORACLE_HASH" \
  --arg v3014FormRadioDeeperKidsApResidualCorpusHash "$V3014_FORM_RADIO_DEEPER_KIDS_AP_RESIDUAL_CORPUS_HASH" \
  ...
  --arg v3014AnnotationFreetextRectResidualCorpusHash "$V3014_ANNOTATION_FREETEXT_RECT_RESIDUAL_CORPUS_HASH" \
  --arg v3014AnnotationFreetextRectResidualOracleHash "$V3014_ANNOTATION_FREETEXT_RECT_RESIDUAL_ORACLE_HASH" \
  --arg v3014AnnotationLinkUriNameResidualCorpusHash "$V3014_ANNOTATION_LINK_URI_NAME_RESIDUAL_CORPUS_HASH" \
  --arg v3014AnnotationLinkUriNameResidualOracleHash "$V3014_ANNOTATION_LINK_URI_NAME_RESIDUAL_ORACLE_HASH" \
  --arg v3014AnnotationLinkAaActionResidualCorpusHash "$V3014_ANNOTATION_LINK_AA_ACTION_RESIDUAL_CORPUS_HASH" \
  --arg v3014AnnotationLinkAaActionResidualOracleHash "$V3014_ANNOTATION_LINK_AA_ACTION_RESIDUAL_ORACLE_HASH" \
  --arg v3014AnnotationLinkAaPrecedenceResidualCorpusHash "$V3014_ANNOTATION_LINK_AA_PRECEDENCE_RESIDUAL_CORPUS_HASH" \
  --arg v3014AnnotationLinkAaPrecedenceResidualOracleHash "$V3014_ANNOTATION_LINK_AA_PRECEDENCE_RESIDUAL_ORACLE_HASH" \
  ...
  --arg v3014AttachmentDupkidsResidualCorpusHash "$V3014_ATTACHMENT_DUPKIDS_RESIDUAL_CORPUS_HASH" \
  --arg v3014AttachmentDupkidsResidualOracleHash "$V3014_ATTACHMENT_DUPKIDS_RESIDUAL_ORACLE_HASH" \
  ...
  --arg v3014FormTextMultilineResidualCorpusHash "$V3014_FORM_TEXT_MULTILINE_RESIDUAL_CORPUS_HASH" \
  ...
  --arg v3014OutlineLaunchResidualCorpusHash "$V3014_OUTLINE_LAUNCH_RESIDUAL_CORPUS_HASH" \
  --arg v3014OutlineLaunchResidualOracleHash "$V3014_OUTLINE_LAUNCH_RESIDUAL_ORACLE_HASH" \
  --arg v3014OutlineRelativeRemoteResidualCorpusHash "$V3014_OUTLINE_RELATIVE_REMOTE_RESIDUAL_CORPUS_HASH" \
  --arg v3014OutlineRelativeRemoteResidualOracleHash "$V3014_OUTLINE_RELATIVE_REMOTE_RESIDUAL_ORACLE_HASH" \
  ...
  --arg v3014PageGeometryDepthClampResidualCorpusHash "$V3014_PAGE_GEOMETRY_DEPTH_CLAMP_RESIDUAL_CORPUS_HASH" \
  --arg v3014PageGeometryDepthClampResidualOracleHash "$V3014_PAGE_GEOMETRY_DEPTH_CLAMP_RESIDUAL_ORACLE_HASH" \
  --arg v3014PageGeometryUserunitMultipageResidualCorpusHash "$V3014_PAGE_GEOMETRY_USERUNIT_MULTIPAGE_RESIDUAL_CORPUS_HASH" \
  --arg v3014PageGeometryUserunitMultipageResidualOracleHash "$V3014_PAGE_GEOMETRY_USERUNIT_MULTIPAGE_RESIDUAL_ORACLE_HASH" \
  ...
  --argjson v3014FormRadioAsNoOverrideResidualCaseCount "$V3014_FORM_RADIO_AS_NO_OVERRIDE_RESIDUAL_CASE_COUNT" \
  --argjson v3014FormRadioAsNoOverrideResidualPassed "$V3014_FORM_RADIO_AS_NO_OVERRIDE_RESIDUAL_PASSED" \
  --argjson v3014FormRadioAsNoOverrideResidualSkipped "$V3014_FORM_RADIO_AS_NO_OVERRIDE_RESIDUAL_SKIPPED" \
  --argjson v3014FormCheckboxMultiExportResidualCaseCount "$V3014_FORM_CHECKBOX_MULTI_EXPORT_RESIDUAL_CASE_COUNT" \
  --argjson v3014FormCheckboxMultiExportResidualPassed "$V3014_FORM_CHECKBOX_MULTI_EXPORT_RESIDUAL_PASSED" \
  --argjson v3014FormCheckboxMultiExportResidualSkipped "$V3014_FORM_CHECKBOX_MULTI_EXPORT_RESIDUAL_SKIPPED" \
  --argjson v3014FormCheckboxMultiExportManyResidualCaseCount "$V3014_FORM_CHECKBOX_MULTI_EXPORT_MANY_RESIDUAL_CASE_COUNT" \
  --argjson v3014FormCheckboxMultiExportManyResidualPassed "$V3014_FORM_CHECKBOX_MULTI_EXPORT_MANY_RESIDUAL_PASSED" \
  --argjson v3014FormCheckboxMultiExportManyResidualSkipped "$V3014_FORM_CHECKBOX_MULTI_EXPORT_MANY_RESIDUAL_SKIPPED" \
  --argjson v3014FormCheckboxExportEmptySingleResidualCaseCount "$V3014_FORM_CHECKBOX_EXPORT_EMPTY_SINGLE_RESIDUAL_CASE_COUNT" \
  --argjson v3014FormCheckboxExportEmptySingleResidualPassed "$V3014_FORM_CHECKBOX_EXPORT_EMPTY_SINGLE_RESIDUAL_PASSED" \
  --argjson v3014FormCheckboxExportEmptySingleResidualSkipped "$V3014_FORM_CHECKBOX_EXPORT_EMPTY_SINGLE_RESIDUAL_SKIPPED" \
  --argjson v3014FormCheckboxMalformedApResidualCaseCount "$V3014_FORM_CHECKBOX_MALFORMED_AP_RESIDUAL_CASE_COUNT" \
  --argjson v3014FormCheckboxMalformedApResidualPassed "$V3014_FORM_CHECKBOX_MALFORMED_AP_RESIDUAL_PASSED" \
  --argjson v3014FormCheckboxMalformedApResidualSkipped "$V3014_FORM_CHECKBOX_MALFORMED_AP_RESIDUAL_SKIPPED" \
  --argjson v3014FormRadioMalformedApResidualCaseCount "$V3014_FORM_RADIO_MALFORMED_AP_RESIDUAL_CASE_COUNT" \
  --argjson v3014FormRadioMalformedApResidualPassed "$V3014_FORM_RADIO_MALFORMED_AP_RESIDUAL_PASSED" \
  --argjson v3014FormRadioMalformedApResidualSkipped "$V3014_FORM_RADIO_MALFORMED_AP_RESIDUAL_SKIPPED" \
  --argjson v3014FormRadioParentKidsApResidualCaseCount "$V3014_FORM_RADIO_PARENT_KIDS_AP_RESIDUAL_CASE_COUNT" \
  --argjson v3014FormRadioParentKidsApResidualPassed "$V3014_FORM_RADIO_PARENT_KIDS_AP_RESIDUAL_PASSED" \
  --argjson v3014FormRadioParentKidsApResidualSkipped "$V3014_FORM_RADIO_PARENT_KIDS_AP_RESIDUAL_SKIPPED" \
  --argjson v3014FormRadioDeeperKidsApResidualCaseCount "$V3014_FORM_RADIO_DEEPER_KIDS_AP_RESIDUAL_CASE_COUNT" \
  --argjson v3014FormRadioDeeperKidsApResidualPassed "$V3014_FORM_RADIO_DEEPER_KIDS_AP_RESIDUAL_PASSED" \
  --argjson v3014FormRadioDeeperKidsApResidualSkipped "$V3014_FORM_RADIO_DEEPER_KIDS_AP_RESIDUAL_SKIPPED" \
  ...
  --argjson v3014AnnotationFreetextRectResidualCaseCount "$V3014_ANNOTATION_FREETEXT_RECT_RESIDUAL_CASE_COUNT" \
  --argjson v3014AnnotationFreetextRectResidualPassed "$V3014_ANNOTATION_FREETEXT_RECT_RESIDUAL_PASSED" \
  --argjson v3014AnnotationFreetextRectResidualSkipped "$V3014_ANNOTATION_FREETEXT_RECT_RESIDUAL_SKIPPED" \
  --argjson v3014AnnotationLinkUriNameResidualCaseCount "$V3014_ANNOTATION_LINK_URI_NAME_RESIDUAL_CASE_COUNT" \
  --argjson v3014AnnotationLinkUriNameResidualPassed "$V3014_ANNOTATION_LINK_URI_NAME_RESIDUAL_PASSED" \
  --argjson v3014AnnotationLinkUriNameResidualSkipped "$V3014_ANNOTATION_LINK_URI_NAME_RESIDUAL_SKIPPED" \
  --argjson v3014AnnotationLinkAaActionResidualCaseCount "$V3014_ANNOTATION_LINK_AA_ACTION_RESIDUAL_CASE_COUNT" \
  --argjson v3014AnnotationLinkAaActionResidualPassed "$V3014_ANNOTATION_LINK_AA_ACTION_RESIDUAL_PASSED" \
  --argjson v3014AnnotationLinkAaActionResidualSkipped "$V3014_ANNOTATION_LINK_AA_ACTION_RESIDUAL_SKIPPED" \
  --argjson v3014AnnotationLinkAaPrecedenceResidualCaseCount "$V3014_ANNOTATION_LINK_AA_PRECEDENCE_RESIDUAL_CASE_COUNT" \
  --argjson v3014AnnotationLinkAaPrecedenceResidualPassed "$V3014_ANNOTATION_LINK_AA_PRECEDENCE_RESIDUAL_PASSED" \
  --argjson v3014AnnotationLinkAaPrecedenceResidualSkipped "$V3014_ANNOTATION_LINK_AA_PRECEDENCE_RESIDUAL_SKIPPED" \
  ...
  --argjson v3014AttachmentDupkidsResidualCaseCount "$V3014_ATTACHMENT_DUPKIDS_RESIDUAL_CASE_COUNT" \
  --argjson v3014AttachmentDupkidsResidualPassed "$V3014_ATTACHMENT_DUPKIDS_RESIDUAL_PASSED" \
  --argjson v3014AttachmentDupkidsResidualSkipped "$V3014_ATTACHMENT_DUPKIDS_RESIDUAL_SKIPPED" \
  ...
  --argjson v3014FormTextMultilineResidualCaseCount "$V3014_FORM_TEXT_MULTILINE_RESIDUAL_CASE_COUNT" \
  --argjson v3014FormTextMultilineResidualPassed "$V3014_FORM_TEXT_MULTILINE_RESIDUAL_PASSED" \
  --argjson v3014FormTextMultilineResidualSkipped "$V3014_FORM_TEXT_MULTILINE_RESIDUAL_SKIPPED" \
  ...
  --argjson v3014OutlineLaunchResidualCaseCount "$V3014_OUTLINE_LAUNCH_RESIDUAL_CASE_COUNT" \
  --argjson v3014OutlineLaunchResidualPassed "$V3014_OUTLINE_LAUNCH_RESIDUAL_PASSED" \
  --argjson v3014OutlineLaunchResidualSkipped "$V3014_OUTLINE_LAUNCH_RESIDUAL_SKIPPED" \
  --argjson v3014OutlineRelativeRemoteResidualCaseCount "$V3014_OUTLINE_RELATIVE_REMOTE_RESIDUAL_CASE_COUNT" \
  --argjson v3014OutlineRelativeRemoteResidualPassed "$V3014_OUTLINE_RELATIVE_REMOTE_RESIDUAL_PASSED" \
  --argjson v3014OutlineRelativeRemoteResidualSkipped "$V3014_OUTLINE_RELATIVE_REMOTE_RESIDUAL_SKIPPED" \
  ...
  --argjson v3014PageGeometryDepthClampResidualCaseCount "$V3014_PAGE_GEOMETRY_DEPTH_CLAMP_RESIDUAL_CASE_COUNT" \
  --argjson v3014PageGeometryDepthClampResidualPassed "$V3014_PAGE_GEOMETRY_DEPTH_CLAMP_RESIDUAL_PASSED" \
  --argjson v3014PageGeometryDepthClampResidualSkipped "$V3014_PAGE_GEOMETRY_DEPTH_CLAMP_RESIDUAL_SKIPPED" \
  --argjson v3014PageGeometryUserunitMultipageResidualCaseCount "$V3014_PAGE_GEOMETRY_USERUNIT_MULTIPAGE_RESIDUAL_CASE_COUNT" \
  --argjson v3014PageGeometryUserunitMultipageResidualPassed "$V3014_PAGE_GEOMETRY_USERUNIT_MULTIPAGE_RESIDUAL_PASSED" \
  --argjson v3014PageGeometryUserunitMultipageResidualSkipped "$V3014_PAGE_GEOMETRY_USERUNIT_MULTIPAGE_RESIDUAL_SKIPPED" \
  ...
  '{
    ...
    v3014FormRadioAsNoOverrideResidualCorpusHash: $v3014FormRadioAsNoOverrideResidualCorpusHash,
    v3014FormRadioAsNoOverrideResidualOracleHash: $v3014FormRadioAsNoOverrideResidualOracleHash,
    v3014FormCheckboxMultiExportResidualCorpusHash: $v3014FormCheckboxMultiExportResidualCorpusHash,
    v3014FormCheckboxMultiExportResidualOracleHash: $v3014FormCheckboxMultiExportResidualOracleHash,
    v3014FormCheckboxMultiExportManyResidualCorpusHash: $v3014FormCheckboxMultiExportManyResidualCorpusHash,
    v3014FormCheckboxMultiExportManyResidualOracleHash: $v3014FormCheckboxMultiExportManyResidualOracleHash,
    v3014FormCheckboxExportEmptySingleResidualCorpusHash: $v3014FormCheckboxExportEmptySingleResidualCorpusHash,
    v3014FormCheckboxExportEmptySingleResidualOracleHash: $v3014FormCheckboxExportEmptySingleResidualOracleHash,
    v3014FormCheckboxMalformedApResidualCorpusHash: $v3014FormCheckboxMalformedApResidualCorpusHash,
    v3014FormCheckboxMalformedApResidualOracleHash: $v3014FormCheckboxMalformedApResidualOracleHash,
    v3014FormRadioMalformedApResidualCorpusHash: $v3014FormRadioMalformedApResidualCorpusHash,
    v3014FormRadioMalformedApResidualOracleHash: $v3014FormRadioMalformedApResidualOracleHash,
    v3014FormRadioParentKidsApResidualCorpusHash: $v3014FormRadioParentKidsApResidualCorpusHash,
    v3014FormRadioParentKidsApResidualOracleHash: $v3014FormRadioParentKidsApResidualOracleHash,
    v3014FormRadioDeeperKidsApResidualCorpusHash: $v3014FormRadioDeeperKidsApResidualCorpusHash,
    ...
    v3014AnnotationFreetextRectResidualCorpusHash: $v3014AnnotationFreetextRectResidualCorpusHash,
    v3014AnnotationFreetextRectResidualOracleHash: $v3014AnnotationFreetextRectResidualOracleHash,
    v3014AnnotationLinkUriNameResidualCorpusHash: $v3014AnnotationLinkUriNameResidualCorpusHash,
    v3014AnnotationLinkUriNameResidualOracleHash: $v3014AnnotationLinkUriNameResidualOracleHash,
    v3014AnnotationLinkAaActionResidualCorpusHash: $v3014AnnotationLinkAaActionResidualCorpusHash,
    v3014AnnotationLinkAaActionResidualOracleHash: $v3014AnnotationLinkAaActionResidualOracleHash,
    v3014AnnotationLinkAaPrecedenceResidualCorpusHash: $v3014AnnotationLinkAaPrecedenceResidualCorpusHash,
    v3014AnnotationLinkAaPrecedenceResidualOracleHash: $v3014AnnotationLinkAaPrecedenceResidualOracleHash,
    ...
    v3014AttachmentDupkidsResidualCorpusHash: $v3014AttachmentDupkidsResidualCorpusHash,
    v3014AttachmentDupkidsResidualOracleHash: $v3014AttachmentDupkidsResidualOracleHash,
    ...
    v3014FormTextMultilineResidualCorpusHash: $v3014FormTextMultilineResidualCorpusHash,
    ...
    v3014OutlineLaunchResidualCorpusHash: $v3014OutlineLaunchResidualCorpusHash,
    v3014OutlineLaunchResidualOracleHash: $v3014OutlineLaunchResidualOracleHash,
    v3014OutlineRelativeRemoteResidualCorpusHash: $v3014OutlineRelativeRemoteResidualCorpusHash,
    v3014OutlineRelativeRemoteResidualOracleHash: $v3014OutlineRelativeRemoteResidualOracleHash,
    ...
    v3014PageGeometryDepthClampResidualCorpusHash: $v3014PageGeometryDepthClampResidualCorpusHash,
    v3014PageGeometryDepthClampResidualOracleHash: $v3014PageGeometryDepthClampResidualOracleHash,
    v3014PageGeometryUserunitMultipageResidualCorpusHash: $v3014PageGeometryUserunitMultipageResidualCorpusHash,
    v3014PageGeometryUserunitMultipageResidualOracleHash: $v3014PageGeometryUserunitMultipageResidualOracleHash,
    ...
    immutableFormRadioAsNoOverrideResidualOracle: "scripts/differential/fixtures/v3014-form-radio-as-no-override-residual-oracle.json",
    immutableFormRadioAsNoOverrideResidualDifferential: "scripts/differential/check-v3014-form-radio-as-no-override-residual-differential.ts",
    immutableFormCheckboxMultiExportResidualOracle: "scripts/differential/fixtures/v3014-form-checkbox-multi-export-residual-oracle.json",
    immutableFormCheckboxMultiExportResidualDifferential: "scripts/differential/check-v3014-form-checkbox-multi-export-residual-differential.ts",
    immutableFormCheckboxMultiExportManyResidualOracle: "scripts/differential/fixtures/v3014-form-checkbox-multi-export-many-residual-oracle.json",
    immutableFormCheckboxMultiExportManyResidualDifferential: "scripts/differential/check-v3014-form-checkbox-multi-export-many-residual-differential.ts",
    immutableFormCheckboxExportEmptySingleResidualOracle: "scripts/differential/fixtures/v3014-form-checkbox-export-empty-single-residual-oracle.json",
    immutableFormCheckboxExportEmptySingleResidualDifferential: "scripts/differential/check-v3014-form-checkbox-export-empty-single-residual-differential.ts",
    immutableFormCheckboxMalformedApResidualOracle: "scripts/differential/fixtures/v3014-form-checkbox-malformed-ap-residual-oracle.json",
    immutableFormCheckboxMalformedApResidualDifferential: "scripts/differential/check-v3014-form-checkbox-malformed-ap-residual-differential.ts",
    immutableFormRadioMalformedApResidualOracle: "scripts/differential/fixtures/v3014-form-radio-malformed-ap-residual-oracle.json",
    immutableFormRadioMalformedApResidualDifferential: "scripts/differential/check-v3014-form-radio-malformed-ap-residual-differential.ts",
    immutableFormRadioParentKidsApResidualOracle: "scripts/differential/fixtures/v3014-form-radio-parent-kids-ap-residual-oracle.json",
    immutableFormRadioParentKidsApResidualDifferential: "scripts/differential/check-v3014-form-radio-parent-kids-ap-residual-differential.ts",
    immutableFormRadioDeeperKidsApResidualOracle: "scripts/differential/fixtures/v3014-form-radio-deeper-kids-ap-residual-oracle.json",
    ...
    immutableAnnotationFreetextRectResidualOracle: "scripts/differential/fixtures/v3014-annotation-freetext-rect-residual-oracle.json",
    immutableAnnotationFreetextRectResidualDifferential: "scripts/differential/check-v3014-annotation-freetext-rect-residual-differential.ts",
    immutableAnnotationLinkUriNameResidualOracle: "scripts/differential/fixtures/v3014-annotation-link-uri-name-residual-oracle.json",
    immutableAnnotationLinkUriNameResidualDifferential: "scripts/differential/check-v3014-annotation-link-uri-name-residual-differential.ts",
    immutableAnnotationLinkAaActionResidualOracle: "scripts/differential/fixtures/v3014-annotation-link-aa-action-residual-oracle.json",
    immutableAnnotationLinkAaActionResidualDifferential: "scripts/differential/check-v3014-annotation-link-aa-action-residual-differential.ts",
    immutableAnnotationLinkAaPrecedenceResidualOracle: "scripts/differential/fixtures/v3014-annotation-link-aa-precedence-residual-oracle.json",
    immutableAnnotationLinkAaPrecedenceResidualDifferential: "scripts/differential/check-v3014-annotation-link-aa-precedence-residual-differential.ts",
    ...
    immutableAttachmentDupkidsResidualOracle: "scripts/differential/fixtures/v3014-attachment-dupkids-residual-oracle.json",
    immutableAttachmentDupkidsResidualDifferential: "scripts/differential/check-v3014-attachment-dupkids-residual-differential.ts",
    ...
    immutableFormTextMultilineResidualOracle: "scripts/differential/fixtures/v3014-form-text-multiline-residual-oracle.json",
    ...
    immutableOutlineLaunchResidualOracle: "scripts/differential/fixtures/v3014-outline-launch-residual-oracle.json",
    immutableOutlineLaunchResidualDifferential: "scripts/differential/check-v3014-outline-launch-residual-differential.ts",
    immutableOutlineRelativeRemoteResidualOracle: "scripts/differential/fixtures/v3014-outline-relative-remote-residual-oracle.json",
    immutableOutlineRelativeRemoteResidualDifferential: "scripts/differential/check-v3014-outline-relative-remote-residual-differential.ts",
    ...
    immutablePageGeometryDepthClampResidualOracle: "scripts/differential/fixtures/v3014-page-geometry-depth-clamp-residual-oracle.json",
    immutablePageGeometryDepthClampResidualDifferential: "scripts/differential/check-v3014-page-geometry-depth-clamp-residual-differential.ts",
    immutablePageGeometryUserunitMultipageResidualOracle: "scripts/differential/fixtures/v3014-page-geometry-userunit-multipage-residual-oracle.json",
    immutablePageGeometryUserunitMultipageResidualDifferential: "scripts/differential/check-v3014-page-geometry-userunit-multipage-residual-differential.ts",
    ...
    retirementGate: "scripts/check-no-ts-stdio-backend.sh (sole-Rust: forbids TS export/fallback when dropInFor3014=true)"
  }' >"$ARTIFACT"
