...
const normalizeSource = (value: string): string => {
  ...
  for (const marker of ['v3014-form-pushbutton-ap-default-null-v1.pdf', 'v3014-form-pushbutton-noap-default-null-v1.pdf', 'v3014-form-checkbox-ap-default-off-v1.pdf']) {
...
export const canonicalFormPushbuttonDefaultNullResidualResult = (response: unknown): Json => {
