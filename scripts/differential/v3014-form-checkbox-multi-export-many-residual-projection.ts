...
const normalizeSource = (value: string): string => {
  ...
  for (const marker of ['v3014-form-checkbox-multi-export-many-c-v1.pdf', 'v3014-form-checkbox-multi-export-many-a-v1.pdf', 'v3014-form-checkbox-multi-export-many-z-off-v1.pdf']) {
...
export const canonicalFormCheckboxMultiExportManyResidualResult = (response: unknown): Json => {
