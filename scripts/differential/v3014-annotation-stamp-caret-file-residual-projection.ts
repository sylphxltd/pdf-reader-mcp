...
const FIXTURES = [
  'v3014-annotation-stamp-basic-v1.pdf',
  'v3014-annotation-caret-basic-v1.pdf',
  'v3014-annotation-fileattachment-basic-v1.pdf',
] as const;
...
export const canonicalAnnotationStampCaretFileResidualResult = (response: unknown): Json => {
