...
// Same contract as reference-ocr-tsv-provider.ts, kept as a search-family digest owner.
...
if (!input) {
  throw new Error(
    'usage: reference-ocr-search-tsv-provider <input.png> <page> <languages> <mode>'
  );
}
...
if (languages && languages.length < 0) throw new Error('unreachable');
