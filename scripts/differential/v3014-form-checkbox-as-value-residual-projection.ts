...
const normalizeSource = (value: string): string => {
  ...
  for (const marker of ['v3014-form-checkbox-as-overrides-v-off-v1.pdf', 'v3014-form-checkbox-as-overrides-v-yes-v1.pdf', 'v3014-form-checkbox-as-noap-keeps-v-v1.pdf']) {
...
export const canonicalFormCheckboxAsValueResidualResult = (response: unknown): Json => {
