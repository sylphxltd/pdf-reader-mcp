...
const FIXTURES = [
  'v3014-annotation-square-inverted-v1.pdf',
  'v3014-annotation-circle-inverted-v1.pdf',
  'v3014-annotation-widget-field-t-v1.pdf',
] as const;
...
export const canonicalAnnotationSquareCircleWidgetResidualResult = (response: unknown): Json => {
