...
const normalizeSource = (value: string): string => {
  ...
  for (const marker of ['v3014-form-residual-v1.pdf', 'v3014-form-coercion-v1.pdf', 'v3014-form-radio-group-v1.pdf', 'v3014-form-radio-group-three-v1.pdf']) {
...
export const canonicalFormRadioGroupResult = (response: unknown): Json => {
