...
const normalizeSource = (value: string): string => {
  ...
  for (const marker of ['v3014-form-checkbox-multi-export-foo-v1.pdf', 'v3014-form-checkbox-multi-export-as-bar-v1.pdf', 'v3014-form-checkbox-multi-export-as-baz-off-v1.pdf']) {
...
export const canonicalFormCheckboxMultiExportResidualResult = (response: unknown): Json => {
