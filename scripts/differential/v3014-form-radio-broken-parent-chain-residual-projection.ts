...
const normalizeSource = (value: string): string => {
  ...
  for (const marker of ['v3014-form-radio-broken-parent-ap-stream-v1.pdf', 'v3014-form-radio-broken-parent-apn-stream-v1.pdf', 'v3014-form-radio-broken-parent-ap-named-v1.pdf']) {
...
export const canonicalFormRadioBrokenParentChainResidualResult = (response: unknown): Json => {
