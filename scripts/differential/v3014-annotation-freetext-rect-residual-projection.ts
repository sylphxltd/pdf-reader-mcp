...
const FIXTURES = [
  'v3014-annotation-freetext-inverted-v1.pdf',
  'v3014-annotation-freetext-normal-v1.pdf',
  'v3014-annotation-freetext-zero-width-v1.pdf',
] as const;
...
export const canonicalAnnotationFreetextRectResidualResult = (response: unknown): Json => {
