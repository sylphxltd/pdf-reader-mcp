...
const normalizeSource = (value: string): string => {
  ...
  for (const marker of ['v3014-form-radio-as-does-not-override-v-v1.pdf', 'v3014-form-radio-as-invalid-keeps-v-v1.pdf', 'v3014-form-radio-checkbox-as-regression-v1.pdf']) {
...
export const canonicalFormRadioAsNoOverrideResidualResult = (response: unknown): Json => {
