...
const FIXTURES = [
  'v3014-attachment-invalid-uf-valid-v1.pdf',
  'v3014-attachment-invalid-uf-nofallback-v1.pdf',
  'v3014-attachment-invalid-uf-fonly-v1.pdf',
] as const;
...
export const canonicalAttachmentInvalidUfResidualResult = (response: unknown): Json => {
