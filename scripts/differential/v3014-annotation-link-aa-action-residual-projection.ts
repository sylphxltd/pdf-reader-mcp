...
const FIXTURES = [
  'v3014-annotation-link-aa-u-uri-v1.pdf',
  'v3014-annotation-link-aa-d-goto-v1.pdf',
  'v3014-annotation-link-a-wins-over-aa-v1.pdf',
] as const;
...
export const canonicalAnnotationLinkAaActionResidualResult = (response: unknown): Json => {
