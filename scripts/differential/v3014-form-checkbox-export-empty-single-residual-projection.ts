...
const normalizeSource = (value: string): string => {
  ...
  for (const marker of ['v3014-form-checkbox-export-empty-ap-yes-v1.pdf', 'v3014-form-checkbox-export-single-foo-v1.pdf', 'v3014-form-checkbox-export-single-bar-off-v1.pdf']) {
...
export const canonicalFormCheckboxExportEmptySingleResidualResult = (response: unknown): Json => {
