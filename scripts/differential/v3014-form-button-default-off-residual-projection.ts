...
const normalizeSource = (value: string): string => {
  ...
  for (const marker of ['v3014-form-checkbox-ap-default-off-v1.pdf', 'v3014-form-radio-ap-default-off-v1.pdf', 'v3014-form-checkbox-noap-default-null-v1.pdf']) {
...
export const canonicalFormButtonDefaultOffResidualResult = (response: unknown): Json => {
