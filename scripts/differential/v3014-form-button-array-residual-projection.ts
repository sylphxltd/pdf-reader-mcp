...
const normalizeSource = (value: string): string => {
  ...
  for (const marker of ['v3014-form-button-array-v-v1.pdf', 'v3014-form-button-array-dv-v1.pdf']) {
...
export const canonicalFormButtonArrayResidualResult = (response: unknown): Json => {
