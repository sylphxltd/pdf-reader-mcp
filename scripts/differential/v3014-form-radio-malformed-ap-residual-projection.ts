...
const normalizeSource = (value: string): string => {
  ...
  for (const marker of ['v3014-form-radio-ap-stream-keeps-v-v1.pdf', 'v3014-form-radio-apn-stream-keeps-v-v1.pdf', 'v3014-form-radio-ap-named-keeps-v-v1.pdf']) {
...
export const canonicalFormRadioMalformedApResidualResult = (response: unknown): Json => {
