...
const normalizeSource = (value: string): string => {
  ...
  for (const marker of ['v3014-form-checkbox-as-invalid-export-off-v1.pdf', 'v3014-form-checkbox-as-only-off-yes-v1.pdf', 'v3014-form-checkbox-as-off-export-ok-v1.pdf']) {
...
export const canonicalFormCheckboxExportNormalizeResidualResult = (response: unknown): Json => {
