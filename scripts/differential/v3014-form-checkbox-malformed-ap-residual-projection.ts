...
const normalizeSource = (value: string): string => {
  ...
  for (const marker of ['v3014-form-checkbox-ap-stream-keeps-v-v1.pdf', 'v3014-form-checkbox-apn-stream-keeps-v-v1.pdf', 'v3014-form-checkbox-ap-named-as-off-v1.pdf']) {
...
export const canonicalFormCheckboxMalformedApResidualResult = (response: unknown): Json => {
