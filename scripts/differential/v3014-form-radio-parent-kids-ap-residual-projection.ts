...
const normalizeSource = (value: string): string => {
  ...
  for (const marker of ['v3014-form-radio-kids-ap-stream-v1.pdf', 'v3014-form-radio-kids-apn-stream-v1.pdf', 'v3014-form-radio-kids-ap-named-v1.pdf']) {
...
export const canonicalFormRadioParentKidsApResidualResult = (response: unknown): Json => {
