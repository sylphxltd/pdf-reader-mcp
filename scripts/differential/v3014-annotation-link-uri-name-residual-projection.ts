...
const FIXTURES = [
  'v3014-annotation-link-uri-name-v1.pdf',
  'v3014-annotation-link-uri-javascript-v1.pdf',
  'v3014-annotation-link-uri-relative-v1.pdf',
] as const;
...
const projectAnnotation = (value: unknown, context: string): Json => {
  ...
  const projected: Record<string, Json> = {
    ...
    url: string(annotation.url, `${context}.url`),
...
export const canonicalAnnotationLinkUriNameResidualResult = (response: unknown): Json => {
