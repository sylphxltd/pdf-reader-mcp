...
const FIXTURES = [
  'v3014-annotation-link-uri-domain-v1.pdf',
  'v3014-annotation-link-uri-path-v1.pdf',
  'v3014-annotation-link-uri-www-v1.pdf',
] as const;
...
export const canonicalAnnotationLinkUriNormalizeResidualResult = (response: unknown): Json => {
